...
const translations = {
  en: {
    ...
    dashboard: {
      ...
      manageAnimalsAndCages: "Manage your laboratory animals and cages",
  ...
  es: {
    ...
    dashboard: {
      ...
      manageAnimalsAndCages: "Gestiona tus animales y jaulas de laboratorio",
      ...
      generated: "Generados",
      attention: "Atención",
      recentAnimals: "Animales Recientes",
      viewAll: "Ver Todos",
      all: "Todos",
