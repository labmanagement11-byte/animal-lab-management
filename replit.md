...
- **QR Code Integration**:
    ...
    - **Camera Controls**: Rear camera only (environment facing mode), manual/auto focus modes with tap-to-focus, 60 FPS scanning, HD video (1920x1080), responsive QR box (75% viewport).
